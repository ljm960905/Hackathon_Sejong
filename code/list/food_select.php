				...
				<!-- Main -->
					<article id="main">
						...
						<section class="wrapper style3">
							...
							echo $__GET['id'];
							$q = "SELECT * FROM restaurant_list WHERE res_type = '".$__GET['type']."'";
							...
							$q = "SELECT * FROM restaurant_list WHERE res_type='한식' ORDER BY idx DESC LIMIT $start_record, $record_to_get";
							$result = $mysqli->query($q);
								?>
